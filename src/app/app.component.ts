...
import { Conversations } from './conversation/conversation.component';
  ...
  template: `
    <md-content>
      <md-toolbar color="primary">
          ...
          <button md-button router-active [routerLink]=" ['Conversations'] ">
            Conversation
          </button>
...
@RouteConfig([
  ...
  { path: '/conversation', component: Conversations, name: 'Conversations' },
